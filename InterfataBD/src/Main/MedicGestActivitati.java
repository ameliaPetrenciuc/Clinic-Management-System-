...
public class MedicGestActivitati extends javax.swing.JFrame {
    ...
    public MedicGestActivitati(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Optiuni Medic ");
        ...
        jLabel4.setText("Completeaza raport");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/checklist.png"))); // NOI18N
        ...
        jLabel6.setText("Pacienti programati");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/team.png"))); // NOI18N
        ...
        jLabel8.setText("Istoric pacienti");
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/history.png"))); // NOI18N
    ...
    private void jLabel17MouseClicked(MouseEvent evt) {
        OptiuniUtilizator op= new OptiuniUtilizator(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }

    private void jLabel8MouseClicked(MouseEvent evt) {
        new VeziIstoricPacientMedic(id_utilizator, functie);
        dispose();
    }
    ...
    private void jLabel6MouseClicked(MouseEvent evt) {
        new VeziPacientiProgramatiMedic(id_utilizator, functie);
        dispose();
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MedicGestActivitati().setVisible(true);
        });
    }*/
