...
public class OptiuniUtilizator extends javax.swing.JFrame {
    ...
    public OptiuniUtilizator(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        setTitle("Welcome to cont Utilizator");

        jPanel3.setBackground(new java.awt.Color(0, 153, 153));

        jLabel10.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Optiuni");
        ...
        jLabel3.setText("Cont Utilizator");
        ...
        jLabel4.setText("Optiuni financiar contabile");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/accounting.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/human-resources.png"))); // NOI18N
        ...
        jLabel8.setText("Gestiune activitati");
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/time-management.png"))); // NOI18N
    ...
    private void jLabel6MouseClicked(MouseEvent evt) {
        if(functie==1) {
            InspectorResUmane op = new InspectorResUmane(id_utilizator, functie);
            op.setVisible(true);
        }
        else if(functie==2){
            ExFinResUmane op = new ExFinResUmane(id_utilizator, functie);
            op.setVisible(true);
        }
        else if(functie==3){
            ReceptionerResUmane op = new ReceptionerResUmane(id_utilizator,functie);
            op.setVisible(true);
        }
        else if(functie==4){
            AsistentResUmane op = new AsistentResUmane(id_utilizator,functie);
            op.setVisible(true);
        }
        else if(functie==5){
            MedicResUmane op = new MedicResUmane(id_utilizator,functie);
            op.setVisible(true);
        }
    ...
    //gestiune activitati op
    private void jLabel8MouseClicked(MouseEvent evt) {
        if(functie==1) {
            JOptionPane.showMessageDialog(null, "You have no access!", "Error", JOptionPane.WARNING_MESSAGE);
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new OptiuniUtilizator().setVisible(true);
        });
    }*/
