...
public class InspectorOpFinanciare extends javax.swing.JFrame {
    ...
    public InspectorOpFinanciare(int id_utilizator,int functie) {
    ...
    private void initComponents() {
        ...
        setTitle("Operatii Financiare Contabile");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/calendar_money_nou.png"))); // NOI18N
   ...
   /* public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new InspectorOpFinanciare().setVisible(true);
        });
    }*/
