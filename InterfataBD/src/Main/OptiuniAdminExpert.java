...
public class OptiuniAdminExpert extends javax.swing.JFrame {

    public int admin_lvl;
    String username;
    public  OptiuniAdminExpert(int admin_lvl) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Optiune dorita pentru expert contabil");
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {
        AddExpert add= new AddExpert(admin_lvl);
        add.setVisible(true);
        dispose();
    }
   ...
   /* private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new OptiuniAdminExpert().setVisible(true);
        });
    }*/
