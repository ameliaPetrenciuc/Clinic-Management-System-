...
public class ActivitateAdmin extends javax.swing.JFrame {

    public int admin_lvl;
    String username;
   // Admin admin = new Admin();

    public ActivitateAdmin(int admin_lvl) {
    ...
    private void jLabel17MouseClicked(MouseEvent evt) {
        Clinica login= new Clinica(); //editat
   ...
   /* public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ActivitateAdmin(admin_lvl).setVisible(true);
        });
    }*/
