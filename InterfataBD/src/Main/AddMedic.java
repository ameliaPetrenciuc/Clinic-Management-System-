...
public class AddMedic extends javax.swing.JFrame {

    public int admin_lvl;
    Connection connection = null;
    PreparedStatement prp = null;

    public AddMedic(int admin_lvl) {
    ...
    private void initComponents() {
        ...
        competenteField = new javax.swing.JTextField();
        titluField= new javax.swing.JTextField();
        postField= new javax.swing.JTextField();
        jLabel10 = new javax.swing.JLabel();//contract
        jLabelcod = new javax.swing.JLabel();//parafa
        jLabelgrad= new javax.swing.JLabel();//grad
        jLabelsp= new javax.swing.JLabel();//id_sp
        jLabelCompetente= new javax.swing.JLabel();
        ...
        jLabel13.setText("Adaugare Medic");
        ...
        jLabelcod.setForeground(new java.awt.Color(0, 153, 153));
        jLabelcod.setText("Cod parafa");

        spField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                spFieldActionPerformed(evt);
            }
        });
        jLabelsp.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelsp.setForeground(new java.awt.Color(0, 153, 153));
        jLabelsp.setText("ID specializare");

        gradField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gradFieldActionPerformed(evt);
            }
        });
        jLabelgrad.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelgrad.setForeground(new java.awt.Color(0, 153, 153));
        jLabelgrad.setText("Grad medic");

        competenteField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                competenteFieldActionPerformed(evt);
            }
        });
        jLabelCompetente.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelCompetente.setForeground(new java.awt.Color(0, 153, 153));
        jLabelCompetente.setText("Competente");

        titluField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                titluFieldActionPerformed(evt);
            }
        });
        jLabelTitlu.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelTitlu.setForeground(new java.awt.Color(0, 153, 153));
        jLabelTitlu.setText("Titlu Stiintific");
        ...
        jLabelPost.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelPost.setForeground(new java.awt.Color(0, 153, 153));
        jLabelPost.setText("Post Didactic");




        addMedicButton = new javax.swing.JButton();
        addMedicButton.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        addMedicButton.setForeground(new java.awt.Color(0, 153, 153));
        addMedicButton.setText("Adaugare Medic");
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                ...
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(codField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addGap(170, 170, 170)
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jLabelsp)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(spField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jLabelgrad)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(gradField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jLabelCompetente)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(competenteField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jLabelTitlu)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(titluField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jLabelPost)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(postField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                                        .addComponent(jLabelCompetente)
                                                                        .addComponent(competenteField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                .addGap(23, 23, 23)
                                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                                        .addComponent(jLabelTitlu)
                                                                        .addComponent(titluField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                .addGap(23, 23, 23)
                                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                                        .addComponent(jLabelPost)
    ...
    private void postFieldActionPerformed(ActionEvent evt) {
    }

    private void titluFieldActionPerformed(ActionEvent evt) {
    }

    private void competenteFieldActionPerformed(ActionEvent evt) {
    }

    private void gradFieldActionPerformed(ActionEvent evt) {
    }

    private void spFieldActionPerformed(ActionEvent evt) {
    }

    private void codFieldActionPerformed(ActionEvent evt) {
    }
    private void addDctorbtnMouseClicked(MouseEvent evt) {
        try {
            ...
            int idSp = Integer.parseInt(spField.getText());
            ...
            try (Connection connection = ConexiuneSQL.Conexiune()) {
                if (connection != null) {
                    ...
                    try (PreparedStatement pst = connection.prepareStatement(sql)) {
                        ...
                        pst.setInt(13, idSp);
                        pst.setInt(14, grad);
                        pst.setString(15, competente);
                        pst.setString(16, titlu);
                        pst.setString(17, post);

                        pst.execute();
                        JOptionPane.showMessageDialog(null, "Medic adăugat cu succes!");
                        afisareMedici(connection);
                    }
                }
    ...
    private void afisareMedici(Connection connection) {
        try {
            String query = "{CALL AFISARE_MEDICI()}";
            try (PreparedStatement pst = connection.prepareStatement(query);
                 ResultSet rs = pst.executeQuery()) {

                // Create a new frame to display the user table
                JFrame userTableFrame = new JFrame("Afisare Medici");
    ...
    private void jLabel21MouseClicked(MouseEvent evt) {
     OptiuniAdminMedic opp = new OptiuniAdminMedic(admin_lvl);
        opp.setVisible(true);
        dispose();
    }
   ...
   /* public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new AddMedic().setVisible(true);
        });
    }*/
    private javax.swing.JLabel jLabelcod;
    private javax.swing.JLabel  jLabelCompetente;
    ...
    private javax.swing.JTextField competenteField;
    private javax.swing.JTextField titluField;
