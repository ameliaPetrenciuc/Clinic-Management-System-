...
public class ReceptionerResUmane extends javax.swing.JFrame {
    ...
    public ReceptionerResUmane(int id_utilizator, int functie) {
    ...
    private void jLabel17MouseClicked(MouseEvent evt) {
       OptiuniUtilizator login= new OptiuniUtilizator(0, 0); //editat
    ...
    private void jLabel4MouseClicked(MouseEvent evt) {
       ReceptionerVeziOrar op  = new  ReceptionerVeziOrar( id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ReceptionerResUmane().setVisible(true);
        });
    }*/
