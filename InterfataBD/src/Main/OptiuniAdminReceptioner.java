...
public class OptiuniAdminReceptioner extends javax.swing.JFrame {

    public int admin_lvl;
    String username;
    public  OptiuniAdminReceptioner(int admin_lvl) {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Arial", 1, 30));
        ...
        jLabel3.setFont(new java.awt.Font("Arial Narrow", 0, 30));
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("   dorita  ");
        jLabel3.setToolTipText("");

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/login.png")));
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/back.png")));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/more.png")));
        ...
        jLabel10.setText("Optiune dorita pentru receptioner");
...
*/
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {
        AddReceptioner add= new AddReceptioner(admin_lvl);
        add.setVisible(true);
        dispose();
    }
   ...
   /* public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new OptiuniAdminReceptioner().setVisible(true);
        });
    }*/
