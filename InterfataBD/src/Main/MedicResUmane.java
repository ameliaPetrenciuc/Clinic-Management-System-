...
public class MedicResUmane extends javax.swing.JFrame {
    ...
    public MedicResUmane(int id_utilizator, int functie) {
    ...
    private void afisareConcediu(Connection connection) {
        try {
            String query = "{CALL vezi_concediu("+id_utilizator+")}";
    ...
    private void jLabel5MouseClicked(MouseEvent evt) {
        MedicVeziOrar op  = new MedicVeziOrar(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MedicResUmane().setVisible(true);
        });
    }*/
