...
public class OptiuniAdminInfo extends javax.swing.JFrame {

    public int admin_lvl;
    String username;
    public  OptiuniAdminInfo(int admin_lvl) {
    ...
    private void initComponents() {
        ...
        setTitle("Welcome to Cont Super Admin !");
        ...
        jLabel10.setText("Optiune dorita pentru admin");
...
*/
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {
        AddAdmin add= new AddAdmin(admin_lvl);
        add.setVisible(true);
        dispose();
    }
   ...
   /* public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new OptiuniAdminInfo().setVisible(true);
        });
    }*/
