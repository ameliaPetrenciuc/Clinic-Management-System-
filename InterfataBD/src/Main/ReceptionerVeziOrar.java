...
public class ReceptionerVeziOrar extends javax.swing.JFrame {
    public int id_utilizator;
    public int functie;
    Connection connection = null;
    PreparedStatement prp = null;

    public ReceptionerVeziOrar(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Vezi Orar - Receptioner");
    ...
    /*public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new ReceptionerVeziOrar().setVisible(true);
        });
    }*/
