...
public class MedicVeziOrar extends javax.swing.JFrame {
    public int id_utilizator;
    public int functie;
    Connection connection = null;
    PreparedStatement prp = null;

    public MedicVeziOrar(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Vezi Orar - Medic");
    ...
    private void jLabel21MouseClicked(MouseEvent evt) {
        MedicResUmane opp = new MedicResUmane(id_utilizator,functie);
        opp.setVisible(true);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new MedicVeziOrar().setVisible(true);
        });
    }*/
