...
public class MedicOpFinanciare extends javax.swing.JFrame {
    ...
    public MedicOpFinanciare(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Vezi proft generat/luna");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/financial-profit.png"))); // NOI18N
        ...
        jLabel6.setText("Vezi salar/propriu");
    ...
    private void jLabel6MouseClicked(MouseEvent evt) {
        new VeziSalarRestul(id_utilizator, functie);
        dispose();
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MedicOpFinanciare().setVisible(true);
        });
    }*/
