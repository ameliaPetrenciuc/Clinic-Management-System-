...
public class AsistentVeziOrar extends javax.swing.JFrame {
    public int id_utilizator;
    public int functie;
    Connection connection = null;
    PreparedStatement prp = null;

    public AsistentVeziOrar(int id_utilizator,int functie) {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Vezi Orar - Asistent");
    ...
    private void jLabel21MouseClicked(MouseEvent evt) {
        AsistentResUmane opp = new AsistentResUmane(id_utilizator, functie);
        opp.setVisible(true);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new AsistentVeziOrar().setVisible(true);
        });
    }*/
