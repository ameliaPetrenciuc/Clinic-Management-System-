...
public class InspectorResUmane extends javax.swing.JFrame {
    ...
    public InspectorResUmane(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Optiuni Inspector");
        ...
        jLabel3.setText("Cont Inspector");
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(160, 120));

        jLabel6.setFont(new java.awt.Font("Arial", 0, 22)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Cauta Angajat");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/job-search.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/calendar_mod.png"))); // NOI18N
        ...
        jLabel11.setText("Adauga concediu");
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/vacation.png"))); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/calendar_nou.png"))); // NOI18N
    ...
    /*private void afisareConcediu(Connection connection) {
        try {
            String query = "{CALL vezi_concediu(3)}";///////////////aici in aprenteaza va fi id ul tilizatorului ce foloseste aplicatia
    ...
    private void jLabel11MouseClicked(MouseEvent evt) {
        InspectorAdaugaConcediu op  = new InspectorAdaugaConcediu(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    ...
    private void jLabel14MouseClicked(MouseEvent evt) {
        InspectorVeziConcediu op  = new InspectorVeziConcediu(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }
    ...
    private void jLabel8MouseClicked(MouseEvent evt) {
        InspectorModificaOrar op  = new InspectorModificaOrar(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }
    ...
    private void jLabel6MouseClicked(MouseEvent evt) {
        InspectorCautaAngajat op  = new InspectorCautaAngajat(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }
    ...
    private void jLabel5MouseClicked(MouseEvent evt) {
        InspectorVeziOrar op  = new InspectorVeziOrar(id_utilizator, functie);
        op.setVisible(true);
        dispose();
    }
    ...
    private void jLabel17MouseClicked(MouseEvent evt) {
        OptiuniUtilizator op= new OptiuniUtilizator(id_utilizator, functie); //edit
        op.setVisible(true);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new InspectorResUmane().setVisible(true);
        });
    }*/
