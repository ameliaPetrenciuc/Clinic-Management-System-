...
public class ExFinVeziOrar extends javax.swing.JFrame {
    public int id_utilizator;
    public int functie;
    Connection connection = null;
    PreparedStatement prp = null;

    public ExFinVeziOrar(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Vezi Orar - Expert Financiar");
    ...
    private void jLabel21MouseClicked(MouseEvent evt) {
        ExFinResUmane opp = new ExFinResUmane(id_utilizator, functie);
        opp.setVisible(true);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new ExFinVeziOrar().setVisible(true);
        });
    }*/
