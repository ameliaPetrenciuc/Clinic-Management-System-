...
public class ReceptionerGestActivitati extends javax.swing.JFrame {
    ...
    public ReceptionerGestActivitati(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        setTitle("Gestiune Activitati");

        jPanel3.setBackground(new java.awt.Color(0, 153, 153));

        jLabel10.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Optiuni Receptioner ");
        ...
        jLabel3.setText("Cont Receptioner");
        ...
        jLabel4.setText("Creeaza programare");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/medical-appointment.png"))); // NOI18N
        ...
        jLabel6.setText("Adaugare pacient");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/add-user.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/bon.png"))); // NOI18N
    ...
    private void jLabel17MouseClicked(MouseEvent evt) {
        OptiuniUtilizator login= new OptiuniUtilizator(id_utilizator, functie);
        login.setVisible(true);
        dispose();
    }

    private void jLabel8MouseClicked(MouseEvent evt) {
        new EmiteBon(id_utilizator, functie);
        dispose();
    }
    ...
    private void jLabel6MouseClicked(MouseEvent evt) {
        new AdaugarePacient(id_utilizator, functie);
        dispose();
    ...
    private void jLabel4MouseClicked(MouseEvent evt) {
        new CreeazaProgramare(id_utilizator, functie);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ReceptionerGestActivitati().setVisible(true);
        });
    }*/
