...
public class ExFinOpFinanciare extends javax.swing.JFrame {
    ...
    public ExFinOpFinanciare(int id_utilizator, int functie) {
    ...
    private void initComponents() {
        ...
        setTitle("Operatii Financiare");

        jPanel3.setBackground(new java.awt.Color(0, 153, 153));

        jLabel10.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Optiuni Expert Financiar");
        ...
        jLabel3.setText("Cont Expert Financiar");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/calendar_money_nou.png"))); // NOI18N
        ...
        jLabel6.setText("Vezi profit/medic");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/doctor.png"))); // NOI18N
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(235, 120));

        jLabel8.setFont(new java.awt.Font("Arial", 0, 22)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Vezi profit/specializare");
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagini/financial-profit.png"))); // NOI18N
    ...
    private void jLabel8MouseClicked(MouseEvent evt) {
        new VeziProfitSpecializareExpertFinanciar(id_utilizator, functie);
        dispose();
    }
    ...
    private void jLabel6MouseClicked(MouseEvent evt) {
        new VeziProfitGeneratMedic(id_utilizator, functie);
        dispose();
    ...
    private void jLabel4MouseClicked(MouseEvent evt) {
        new VeziSalarExpertFinanciar(id_utilizator, functie);
        dispose();
    }
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ExFinOpFinanciare().setVisible(true);
        });
    }*/
