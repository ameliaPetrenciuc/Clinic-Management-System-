...
public class AsistentOpFinanciare extends javax.swing.JFrame {
    ...
    public AsistentOpFinanciare(int id_utilizator, int functie) {
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AsistentOpFinanciare().setVisible(true);
        });
    }*/
