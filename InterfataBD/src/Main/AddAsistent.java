...
public class AddAsistent extends javax.swing.JFrame {

    public int admin_lvl;
    Connection connection = null;
    PreparedStatement prp = null;

    public AddAsistent(int admin_lvl) {
    ...
    private void initComponents() {
       ...
       jLabeltip = new javax.swing.JLabel();
        ...
        addAsistentButton = new javax.swing.JButton();
        clearButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Adaugare Asistent");
        ...
        jLabel13.setText("Adaugare Asistent");
        ...
        jLabeltip.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabeltip.setForeground(new java.awt.Color(0, 153, 153));
        jLabeltip.setText("Tip asistent");
        ...
        jLabelgrad.setText("Grad asistent");


        addAsistentButton = new javax.swing.JButton();
        addAsistentButton.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        addAsistentButton.setForeground(new java.awt.Color(0, 153, 153));
        addAsistentButton.setText("Adaugare Asistent");
        addAsistentButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                addAsistentbtnMouseClicked(evt);
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(addAsistentButton)
                                                                .addGap(18, 18, 18)
    ...
    private void jLabel21MouseClicked(MouseEvent evt) {
        OptiuniAdminAsistent opp = new OptiuniAdminAsistent(admin_lvl);
        opp.setVisible(true);
        dispose();
    }
    ...
    private void tipFieldActionPerformed(ActionEvent evt) {
    }
    private void addAsistentbtnMouseClicked(MouseEvent evt) {
        try {
            ...
            try (Connection connection = ConexiuneSQL.Conexiune()) {
                if (connection != null) {
                    ...
                    try (PreparedStatement pst = connection.prepareStatement(sql)) {
                        ...
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "Asistent adăugat cu succes!");
                        afisareAsistenti(connection);
                    }
                }
    ...
    private void afisareAsistenti(Connection connection) {
        try {
            String query = "{CALL AFISARE_ASISTENTI()}";
            try (PreparedStatement pst = connection.prepareStatement(query);
                 ResultSet rs = pst.executeQuery()) {

                // Create a new frame to display the user table
                JFrame userTableFrame = new JFrame("Afisare Asistenti");
    ...
    /*public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new AddAsistent().setVisible(true);
        });
    }*/
    private javax.swing.JLabel jLabeltip;
    private javax.swing.JLabel jLabelgrad;

    private javax.swing.JButton addAsistentButton;
