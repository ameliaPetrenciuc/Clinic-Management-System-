...
public class OptiuniAdminInspector extends javax.swing.JFrame {

    public int admin_lvl;
    String username;
    public  OptiuniAdminInspector(int admin_lvl) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Optiune dorita pentru inspector");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {
        AddInspector add= new AddInspector(admin_lvl);
        add.setVisible(true);
        dispose();
    }
   ...
   /* private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new OptiuniAdminInspector().setVisible(true);
        });
    }*/
