...
public class ReceptionerOpFinanciare extends javax.swing.JFrame {
    ...
    public ReceptionerOpFinanciare(int id_utilizator,int functie) {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Vezi salariu propriu");
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ReceptionerOpFinanciare().setVisible(true);
        });
    }*/
